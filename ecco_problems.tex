...
\item Let $\P \subset \R^d$ be a full-dimensional polyhedron with dissection $\P = \P_1 \cup \P_2 \cup \cdots \cup \P_m$.
If $\q \in \R^d$ is generic relative to each $\P_i$, then
\[
  \hopen_\q \P \ = \ \hopen_\q \P_1 \uplus \hopen_\q \P_2 \uplus \cdots \uplus
\hopen_\q \P_m  \, .
\]
