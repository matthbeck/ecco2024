...
\red Example \black \ \bm P_3 \em --- family of partitions into at most \bm 3 \em parts
\be
  \sum_{ \lambda \in P_3 } q^{ \lambda_1 + \lambda_2 + \lambda_3 } \ = \ \frac{ 1
}{ (1-q) (1-q^2) (1-q^3) } 
\ee
\red Idea \ 
\bm P_3 \ = \ \left\{ \lambda \in \Z^3 : \, 0 \le \lambda_1 \le \lambda_2 \le
\lambda_3 \right\} \ = \ \K_3 \cap \Z^3 \em 

\hspace{.56in}
\bm \K_3 \ = \ \left\{ \x \in \R^3 : \, 0 \le x_1 \le x_2 \le x_3 \right\} \em
